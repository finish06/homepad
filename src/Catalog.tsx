    ...
    >
      ...
      <div className="mt-3 flex gap-2">
        <input
          ...
          className="flex-1 rounded-lg border border-neutral-300 px-3 py-1.5 text-sm outline-none focus:border-indigo-500 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100 dark:placeholder-neutral-500 dark:focus:border-indigo-400"
        />
        <button
          type="button"
          ...
          disabled={busy}
          onClick={create}
          className="rounded-lg border border-indigo-200 px-3 py-1.5 text-sm font-medium text-indigo-600 hover:bg-indigo-50 disabled:opacity-60 dark:border-indigo-700 dark:text-indigo-400 dark:hover:bg-indigo-950"
        >
          Add category
        </button>
      </div>
  ...
  return (
    <div data-testid="category-row" data-category-id={cat.id} className="flex items-center gap-1">
      <input
        ...
        className="min-w-0 flex-1 rounded-lg border border-neutral-300 px-2 py-1 text-sm outline-none focus:border-indigo-500 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100 dark:focus:border-indigo-400"
      />
      <button
        type="button"
        ...
        disabled={busy}
        onClick={save}
        className="rounded-md border border-neutral-200 px-2 py-1 text-xs font-medium text-neutral-700 hover:bg-neutral-50 disabled:opacity-60 dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-800"
      >
        Save
      </button>
      <button
